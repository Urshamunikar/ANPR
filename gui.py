...
class Toplevel1:
    def __init__(self, top=None):
        ...
        top.configure(background="#7087dc")
        top.configure(highlightbackground="#ececec")
        ...
        self.Label1.configure(text='''SMART PARKING''')
        ...
        # self.Label3.configure(text='''Anisha Basnet''')
        ...
        # self.Label4.configure(text='''Ashmita Raj Napit''')
        # self.Label4.configure(width=170)
        # self.Label5 = tk.Label(top)
        # self.Label5.place(relx=.808, rely=0.933, height=21, width=169)
        # self.Label5.configure(background="#d9d9d9")
        # self.Label5.configure(disabledforeground="#a3a3a3")
        # self.Label5.configure(foreground="#000000")
        # self.Label5.configure(text='''Binisha Maharjan''')
        # self.Label5.configure(width=169)
        # self.Label5 = tk.Label(top)
        # self.Label5.place(relx=.808, rely=0.968, height=21, width=168)
        # self.Label5.configure(background="#d9d9d9")
        # self.Label5.configure(disabledforeground="#a3a3a3")
        # self.Label5.configure(foreground="#000000")
        # self.Label5.configure(text='''Ursha Munikar''')
        # self.Label5.configure(width=168)
        self.TButton1 = tk.Button(top)
        self.TButton1.place(relx=0.843, rely=0.267, height=45, width=116)
        self.TButton1.configure(background="#FFFFFF")
        self.TButton1.configure(activebackground="#d3d3d3")
        ...
        self.Button1.place(relx=0.691, rely=0.933, height=24, width=100)
        self.Button1.configure(activebackground="#d3d3d3")
